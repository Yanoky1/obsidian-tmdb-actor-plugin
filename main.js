...
var init_i18n = __esm({
  "i18n.ts"() {
    ru = {
      ...
      modals: {
        searchTitle: "\u{1F37F} \u041F\u043E\u0438\u0441\u043A \u0430\u043A\u0442\u0435\u0440\u043E\u0432",
      ...
      settings: {
        ...
        saveCoverImageDesc: "\u0421\u043A\u0430\u0447\u0438\u0432\u0430\u0442\u044C \u0438 \u0441\u043E\u0445\u0440\u0430\u043D\u044F\u0442\u044C \u043E\u0431\u043B\u043E\u0436\u043A\u0438/\u0431\u044D\u043A\u0434\u0440\u043E\u043F\u044B \u0430\u043A\u0442\u0435\u0440\u043E\u0432.",
        ...
        seriesFileLocationDesc: "\u041D\u043E\u0432\u044B\u0435 \u0437\u0430\u043C\u0435\u0442\u043A\u0438 \u043E\u0431 \u0430\u043A\u0442\u0435\u0440\u0430\u0445 \u0431\u0443\u0434\u0443\u0442 \u0440\u0430\u0437\u043C\u0435\u0449\u0435\u043D\u044B \u0437\u0434\u0435\u0441\u044C.",
    ...
    en = {
      ...
      modals: {
        searchTitle: "\u{1F37F} Search actors",
      ...
      settings: {
        ...
        saveCoverImageDesc: "Download and save actor cover/backdrop images.",
  ...
  async createNewNote() {
    try {
      ...
      const {
        ...
        // Папка для актёров
        actorFileNameFormat
        // Формат имени файла для актёров
      } = this.settings;
      let fileNameFormat;
      let folderPath;
      const itemType = Array.isArray(movieShow.type) ? movieShow.type[0] : movieShow.type;
